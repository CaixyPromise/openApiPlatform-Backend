...
import com.caixy.backend.config.properties.ThreadPoolExecutionProperties;
...
import static com.caixy.backend.config.properties.ThreadPoolExecutionProperties.createThreadFactory;

/**
 * 线程池管理类
 *
 * @name: com.caixy.backend.manager.ThreadPoolExecutorManager
 * @author: CAIXYPROMISE
 * @since: 2024-01-15 18:43
 **/
@Service
@Slf4j
