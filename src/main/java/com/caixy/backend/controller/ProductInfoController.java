...
import com.caixy.backend.model.dto.product.ProductInfoAddRequest;
import com.caixy.backend.model.dto.product.ProductInfoQueryRequest;
import com.caixy.backend.model.dto.product.ProductInfoSearchTextRequest;
import com.caixy.backend.model.dto.product.ProductInfoUpdateRequest;
import com.caixy.backend.model.entity.ProductInfo;
import com.caixy.backend.model.enums.ProductInfoStatusEnum;
 ...
 * 产品信息接口控制器
 *
 * @name: com.caixy.backend.controller.ProductInfoController
 * @author: CAIXYPROMISE
 * @since: 2024-03-11 02:11
 **/
@RestController
